...
# Восемь товаров события — понятные «морские» вещи.
ITEMS: tuple[str, ...] = (
    "Бочка рома",
    "Мешок специй",
    "Жемчужное ожерелье",
...
MERCHANT_TABLE: tuple[Merchant, ...] = (
    Merchant(name="Купец Тихон", owns="Бочка рома", needs="Мешок специй"),
    Merchant(name="Купчиха Агата", owns="Рулон шёлка", needs="Жемчужное ожерелье"),
    Merchant(name="Боцман Гром", owns="Связка канатов", needs="Карта сокровищ"),
    Merchant(name="Рыбак Сом", owns="Ящик апельсинов", needs="Головка сыра"),
    Merchant(name="Старик Север", owns="Карта сокровищ", needs="Бочка рома"),
)
